...
import { auth, googleProvayder } from "../firebase/firebaseConfig";
...
function Signup() {
  ...
  const handGoogleLogin = (e) => {
    e.preventDefault();
    signInWithPopup(auth, googleProvayder)
      .then((result) => {
  ...
  return (
    <div className="flex items-center justify-center gap-3">
      <h1 className="font-josefin my-4 text-center text-3xl">Sign Up</h1>
        ...
        <form className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="btn btn-info btn-sm md:btn-md hover:bg-blue-900 hover:text-zinc-950"
            >
              Google
            </button>
            <a className="btn btn-warning btn-sm md:btn-md" href="./">
              Sign Up
            </a>
          </div>
        </form>
